...
if __name__== '__main__':
    ...
    #blocco apprendimento dei pesi, tranne ultimo layer di regressione e sigmoide
    #for param in msat.parameters():
    #    param.requires_grad = False
    #contact prediction head with regression and sigmoid
    #for param in msat.contact_h.parameters():
    ...
    #TODO: non mascherare MSA in questo caso
    #TODO: introdurre calcolo accuracy

...
class MSATransf(nn.Module):
    ...
    def __init__(self,args,alphabet_size, padding_idx, mask_idx):
        ...
        self.alphabet_size = alphabet_size + 1 + 1#+1 finale è per il padding idx e mask idx
        ...
        #TODO: forse passare mask_idx invece che padding_idx ---> guardare embedding_pos.py
...
class MSATransfNoCol(nn.Module):
    """MSA transformer inspired model"""
    #define the arguments of the model
    @classmethod
    def args(c, parser):

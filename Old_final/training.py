...
if __name__== '__main__':
    ...
    parser.add_argument("--name_experiment", dest="name_experiment",
                        help="path to the dataset folder (where train, test)")
    parser.add_argument("--count_par", dest="count_par",
                        help="Bool val to determine if you want to only count parameters and see summary of net")                    
    ...
    summary(msat, (256, 16),dtypes=[torch.int])
